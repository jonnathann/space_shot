...
public class Keyboard extends InputBase implements KeyListener
{
	...
	public Keyboard()
    {
            ...
            addKey(KeyEvent.VK_W, Keyboard.DETECT_EVERY_PRESS);
            addKey(KeyEvent.VK_A, Keyboard.DETECT_EVERY_PRESS);
            addKey(KeyEvent.VK_D, Keyboard.DETECT_EVERY_PRESS);
            addKey(KeyEvent.VK_S, Keyboard.DETECT_EVERY_PRESS);
    }
